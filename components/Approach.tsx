...
const Card = ({
  ...
  return (
    ...
    >
      <Icon className="absolute -left-3 -top-3 h-10 w-10 text-black dark:text-white" />
      <Icon className="absolute -bottom-3 -left-3 h-10 w-10 text-black dark:text-white" />
      <Icon className="absolute -right-3 -top-3 h-10 w-10 text-black dark:text-white" />
      <Icon className="absolute -bottom-3 -right-3 h-10 w-10 text-black dark:text-white" />
